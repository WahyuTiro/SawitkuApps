...
public class DownloadFileActivity extends AppCompatActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (bbb != null) {
			file_url = bbb.getString("url");
			nama = bbb.getString("nama");
			caption = bbb.getString("caption");

		}

		TextView namaFile = (TextView)findViewById(R.id.namaFile);
		TextView captionFile = (TextView)findViewById(R.id.captionFile);
		namaFile.setText(nama);
		captionFile.setText(caption);
