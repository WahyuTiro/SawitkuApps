...
import com.sawitku.ListPertanyaan;
import com.sawitku.R;
import com.sawitku.fmodels.Topics;

public class ItemQAFragment extends Fragment {
    ...
    public static ItemQAFragment newInstance() {
        ItemQAFragment fragment = new ItemQAFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final FirebaseRecyclerAdapter<Topics, MovieViewHolder> adapter = new FirebaseRecyclerAdapter<Topics, MovieViewHolder>(
                Topics.class,
                R.layout.qa_list_item,
                MovieViewHolder.class,
                //referencing the node where we want the database to store the data from our Object
                mDatabaseReference.child("qna").getRef()
        ) {
            @Override
            protected void populateViewHolder(final MovieViewHolder viewHolder, Topics kat, final int position) {
                ...
                viewHolder.setOnClickListener(new MovieViewHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        if (!(viewHolder.iv_id.getText().toString().isEmpty())) {
                            Intent k = new Intent(getActivity(), ListPertanyaan.class);
